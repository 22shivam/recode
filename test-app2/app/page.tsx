      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6">
          ...
          <ol className="text-yellow-900 space-y-2 list-decimal list-inside">
            <li>
              <strong>Add Todo:</strong> Fails with "todoText is not a valid
              field"
            </li>
            <li>
              <strong>Toggle Todo:</strong> Fails with "ctx.db.update is not a
              function"
            </li>
            <li>
              <strong>Delete Todo:</strong> Fails with "completed is not a valid
              field"
            </li>
          </ol>
